...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8 border-t shadow-inner">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 max-w-xs">
              A comprehensive solution for managing exams, grades and resit procedures for educational institutions.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-md font-semibold mb-4 text-gray-900 dark:text-gray-100">Resources</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            <h3 className="text-md font-semibold mb-4 text-gray-900 dark:text-gray-100">Contact</h3>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
              <li className="flex items-center">
                <span>Email:</span>
                <a href="mailto:info@exams.edu" className="ml-1 hover:text-primary transition-colors">info@exams.edu</a>
              </li>
              <li className="flex items-center">
                <span>Phone:</span>
                <a href="tel:+1-234-567-8901" className="ml-1 hover:text-primary transition-colors">+1-234-567-8901</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  return (
    <AuthProvider>
      <div className="flex flex-col min-h-screen">
        <Header />
        <main className="flex-1 bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
